...
import { createSocioAction } from "@/lib/actions/socios";

export default function NovoSocioPage() {
  return (
    <div className="mx-auto max-w-xl">
      <PageHeader title="Novo sócio" />

      <Card>
        <form action={createSocioAction} className="flex flex-col gap-4 p-6">
          ...
          <Field label="Participação societária (%)" htmlFor="percentual_participacao">
            <Input id="percentual_participacao" name="percentual_participacao" type="number" step="0.01" min="0" max="100" />
          </Field>
          ...
          <div className="mt-2 flex justify-end gap-3">
            ...
            <Button type="submit">Salvar sócio</Button>
          </div>
        </form>
      </Card>
    </div>
